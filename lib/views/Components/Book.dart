...
class BookComponent extends StatelessWidget
{
    ...
    BookComponent({
        @required this.title, @required this.subtitle, @required this.thumbnail, @required this.reviews, @required this.rating});
    ...
    Widget build(BuildContext context)
    {
        ...
        (
            height: 250,
            margin: EdgeInsets.fromLTRB(24, 7, 24, 24),
            child: Stack
            (
                children: <Widget>
                [
                                    ...
                                    [
                                        ...
                                        (
                                            ...
                                            [
                                                ...
                                                Icon(Icons.arrow_forward_ios, color: Color(0xffbababa).withOpacity(.5), size: 20)
